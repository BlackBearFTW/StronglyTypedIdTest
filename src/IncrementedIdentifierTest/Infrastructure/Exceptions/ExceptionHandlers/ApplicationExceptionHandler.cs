...
using ApplicationException = IncrementedIdentifierTest.Infrastructure.Exceptions.ApplicationException;

namespace IncrementedIdentifierTest.Infrastructure.Exceptions.Handlers;
